...
"""
Module for Physical Switch OCCI backend
"""
...
class SwitchBackend(KindBackend, ActionBackend):
    """
    Physical Switch Backend

    """
    def retrieve(self, entity, extras):
        """
        Physical Switch GET Action implementation.
        ...
        result = odl_glue.get_switch(extras['pop_url'], pop_id, uuid)
...
class SwitchLinkBackend(KindBackend):
    """
    Physical Switch Link backend
    """
    def retrieve(self, link, extras):
        """
        Physical Switch Link GET Action implementation.
